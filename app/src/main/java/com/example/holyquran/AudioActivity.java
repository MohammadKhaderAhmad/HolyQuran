...
public class AudioActivity extends AppCompatActivity {
    ...
    private void loadSurahData() {
        String urlSurah = "https://api.alquran.cloud/v1/surah"; // to get surah name in arabic
        String urlAudioFiles = "https://api.quran.com/api/v4/chapter_recitations/1"; // to get the url mp3 of surah
